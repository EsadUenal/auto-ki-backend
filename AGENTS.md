...
`AUTO_KI_SMTP_HOST`, `AUTO_KI_SMTP_PORT`, `AUTO_KI_SMTP_USER`,
`AUTO_KI_SMTP_PASSWORD`, `AUTO_KI_MAIL_FROM`, `AUTO_KI_STRIPE_LIVE_ERLAUBT`.
Vollständige Produktions-ENV-Matrix: `DEPLOYMENT.md`, Abschnitt 4.
